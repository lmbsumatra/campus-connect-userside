        ...
        <div className="item-container row bg-white">
          ...
          <div className="col-md-6 item-desc">
            ...
            <div className="d-flex justify-content-between align-items-center mb-4">
              <p className="mb-0"><strong>{selectedItem.listing_name}</strong></p>
            ...
            <p><strong>Late Charges:</strong> ₱{selectedItem.late_charges}/hr</p>
            <p><strong>Security Deposit:</strong> ₱{selectedItem.security_deposit}</p>
            <p><strong>Repair and Replacement:</strong> {selectedItem.repair_replacement}</p>
        ...
        <div className="user-info mt-5 bg-white">
          <div className="d-flex justify-content-between align-items-center">
            <div className="d-flex align-items-center">
              ...
              <div>
                <a href={`/userprofile/${userName}`} className="text-dark small text-decoration-none">{userName}</a>
              </div>
            </div>
