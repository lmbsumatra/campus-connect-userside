                                ...
                                <div className="d-block">
                                  ...
                                  <div className="d-flex align-items-center mt-2">
                                    <input
                                      type="time"
                                      placeholder="From"
                                      value={newFrom} // Ensure you have state for newFrom
                                      onChange={(e) =>
                                        setNewFrom(e.target.value)
                                      } // Ensure you have setNewFrom function
                                      className="no-border"
                                    />
                                    <input
                                      type="time"
                                      placeholder="To"
                                      value={newTo} // Ensure you have state for newTo
                                      onChange={(e) => setNewTo(e.target.value)} // Ensure you have setNewTo function
                                      className="no-border"
                                    />
                                    <button
                                      className="btn btn-primary ms-2"
