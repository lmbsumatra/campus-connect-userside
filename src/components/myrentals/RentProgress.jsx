        ...
        <div className="progress-container">
          ...
          <div className="transaction-details">
            ...
            <div className="item-info">
              ...
              <div>
                <p>
                  <strong>Item:</strong> Calculus Text Book
                </p>
                <p>
                  <strong>Rental Period:</strong> June 10 - June 10
                </p>
                <p>
                  <strong>Rental Rate:</strong> 10php
                </p>
                <p>
                  <strong>Total Cost:</strong> 10php
                </p>
              </div>
            </div>
          </div>
          <div className="delivery-info">
            ...
            <p>
              <strong>Location:</strong> TUP-M CIT Building
            </p>
            <p>
              <strong>Method:</strong> Meetup
            </p>
          </div>
