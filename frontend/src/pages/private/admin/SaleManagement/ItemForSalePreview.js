...
function ItemForSalePreview({ selectedItem, loading, error, tags }) {
        ...
        <div className="user-info mt-5 bg-white">
          <div className="d-flex justify-content-between align-items-center">
            <div className="d-flex align-items-center">
              ...
              <div>
                <a href={`/userprofile/${selectedItem.seller.first_name}`} className="text-dark small text-decoration-none">
                  {selectedItem.seller.first_name}
                </a>
              </div>
            </div>
