    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.value}>
            {data.usersStats.currentMonth.total_admins}
          </Text>
        </View>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.value}>
            {data.usersStats.currentMonth.total_students}
          </Text>
        </View>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.value}>
            {data.usersStats.currentMonth.total_superadmins}
          </Text>
        </View>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.value}>
            {data.usersStats.currentMonth.verified_users}
          </Text>
        </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.analysisSection}>
          ...
          <Text style={styles.analysisText}>
            ...
            submissions, and modifications can help identify areas that require
            further attention or improvements.
          </Text>
        </View>
      </View>
        ...
        <View style={styles.analysisSection}>
          ...
          <Text style={styles.analysisText}>
            ...
            data.conversationStats.pastMonth.totalConversations
              ...
              ? "lower"
              : "approximately the same"}{" "}
            compared to the previous month. This suggests that user interaction{" "}
            {data.conversationStats.currentMonth.totalConversations >
            data.conversationStats.pastMonth.totalConversations
            ...
            platform's usability and fostering a more engaging user experience.
          </Text>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        {data.itemForSaleStats.currentMonth.paymentModes.map((mode, index) => (
          <View key={index} style={styles.row}>
        ...
        <View style={styles.analysisSection}>
          ...
          <Text style={styles.analysisText}>
            ...
            {data.itemForSaleStats.currentMonth.averagePrice}, which can provide
            insights into the overall affordability of listed items. Monitoring
      ...
      <View style={styles.section}>
        ...
        {data.listingStats.currentMonth.paymentModeCounts.map((mode, index) => (
          <View key={index} style={styles.row}>
            <Text style={styles.label}>{mode.payment_mode}:</Text>
            <Text style={styles.value}>{mode.count} transactions</Text>
          </View>
        ...
        <View style={styles.analysisSection}>
          ...
          <Text style={styles.analysisText}>
            ...
            data.listingStats.pastMonth.totalListings
              ...
              ? "lower"
              : "approximately the same"}{" "}
            compared to the previous month. This suggests that listing activity{" "}
            {data.listingStats.currentMonth.totalListings >
            data.listingStats.pastMonth.totalListings
            ...
            {data.listingStats.currentMonth.categoryCounts
              .map((cat) => cat.category)
              .join(", ")}{" "}
            can help identify trending items or services. Additionally, tracking
            preferred payment modes ( "Online Payment, Payment upon Meetup" )
            offers insight into user payment preferences.
          </Text>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.analysisSection}>
          ...
          <Text style={styles.analysisText}>
            {(() => {
              const currentPosts = data.postStats.currentMonth.totalPosts || 0;
              const pastPosts = data.postStats.pastMonth.totalPosts || 0;
              const categories =
                data.postStats.currentMonth.postsByCategory || [];
              const statuses = data.postStats.currentMonth.postsByStatus || [];
      ...
      <View style={styles.section}>
        ...
        <View style={styles.analysisSection}>
          ...
          <Text style={styles.analysisText}>
            ...
            {data.rentalTransactionStats.currentMonth.totalTransactions}, which
            is{" "}
            {data.rentalTransactionStats.currentMonth.totalTransactions >
            ...
            , highlighting user preference for a convenient transaction process.
            Additionally, the high number of pending payments (
            ...
            indecision. Monitoring this trend can help improve payment processes
            or provide better guidance to users.
          </Text>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        {data.reportStats.currentMonth.reportsByStatus.map((status, index) => (
          <View key={index} style={styles.row}>
            <Text style={styles.label}>{status.status}:</Text>
            <Text style={styles.value}>{status.count}</Text>
          </View>
        ...
        <View style={styles.analysisSection}>
          ...
          <Text style={styles.analysisText}>
            ...
            , indicating potential issues or disputes related to that category.
            The majority of reports are marked as{" "}
        ...
        <View style={styles.analysisSection}>
          ...
          <Text style={styles.analysisText}>
            ...
            data.reviewStats.pastMonth.totalReviews
              ...
              ? "lower"
              : "approximately the same"}{" "}
            compared to the previous month. The average rating for this month is{" "}
            {data.reviewStats.currentMonth.averageRating} out of 5, indicating{" "}
      ...
      <View style={styles.section}>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.value}>
            {data.transactionReportStats.currentMonth.averageResolutionTime} hrs
          </Text>
        </View>
        <View style={styles.row}>
        ...
        <View style={styles.analysisSection}>
          ...
          <Text style={styles.analysisText}>
            ...
            {data.transactionReportStats.currentMonth.totalReports} transaction
            report(s). The most common report type is related to "
            {data.transactionReportStats.currentMonth.reportsByType[0]
              ?.transaction_type || "Unknown"}
            ", with{" "}
            {data.transactionReportStats.currentMonth.reportsByType[0]?.count ||
              0}{" "}
            ...
            {data.transactionReportStats.currentMonth.responseRate}%, indicating
            a need for improvement if it's below expectations. Most reports are
            under the status of "
      ...
      <View style={styles.footer}>
        <Text style={{ fontSize: 8, color: "#7F8C8D" }}>© 2025 RenTUPeers</Text>
...
const MonthlyReportGenerator = () => {
  ...
  return (
    <div className="p-4">
      ...
      <button onClick={openPdfInNewTab} className="btn btn-primary">
        Open PDF in New Tab
      </button>
    </div>
  );
